...
```
curl -X 'POST' \
  'https://api-sankhya.gigantao.net/auth/login' \
...
```
curl -X 'GET' \
  'https://api-sankhya.gigantao.net/inspection/table-schema?tableName=TFPFUN' \
  -H 'accept: application/json' \
  ...
  ```
  curl -X 'GET' \
  'https://api-sankhya.gigantao.net/inspection/table-relations?tableName=TFPFUN' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BHK4HVtie4cixAQNflfxrgVpZSuOxjSiQrOWiAlasqY'
  ```
  ...
  curl -X 'GET' \
  'https://api-sankhya.gigantao.net/inspection/primary-keys/TFPFUN' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BHK4HVtie4cixAQNflfxrgVpZSuOxjSiQrOWiAlasqY'
  ...
  curl -X 'POST' \
  'https://api-sankhya.gigantao.net/inspection/query' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BHK4HVtie4cixAQNflfxrgVpZSuOxjSiQrOWiAlasqY' \
  -H 'Content-Type: application/json' \
  -d '{
...
nossa fonte de dados é sempre nossa route https://api-sankhya.gigantao.net/inspection/query, para isso sempre

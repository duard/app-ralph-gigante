...
export function LoadingState({
  ...
  if (type === 'pulse') {
    return (
      <div
        className={cn('animate-pulse bg-muted rounded-md', containerSizeClasses[size], className)}
      >
        {children}
      </div>
    );
...
export function Loading({
  ...
  if (isLoading) {
    ...
    return (
      <LoadingState type={type} size={size} message={message} className={className}>
        {fallback}
      </LoadingState>
    );
  }

...
import { Phone, Video, Info, Search, MoreVertical, Users, Bell, BellOff } from 'lucide-react';
...
export function ChatHeader({ conversation, users, onToggleMute, onToggleInfo }: ChatHeaderProps) {
  if (!conversation) {
    return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {conversation.isMuted && <BellOff className="h-4 w-4 text-muted-foreground" />}
            {conversation.type === 'group' && (
